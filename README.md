...
- 동적 멀티트랙: 트랙 메뉴에서 비디오 V1~V4와 오디오 A1~A8을 활성화·비활성화하고, V2~V4 잠금·표시와 A3~A8 잠금·음소거를 트랙별로 독립 제어. 클립이 있는 최상위 트랙은 실수로 제거되지 않도록 보호하며 트랙 수·라우팅·제어 상태는 프로젝트와 Undo/Redo에 보존
