...
- V2 B-roll + A3 연결 오디오 트랙: 미디어 빈에서 플레이헤드로 자료화면·PIP를 추가하거나 V2 타깃 드래그 앤 드롭, 프레임 단위 이동·양끝 트림·표시·잠금·우클릭 삭제와 Undo/Redo, PIP 위치·크기·회전·투명도 Inspector, A3 음소거·볼륨·팬·페이드·독립 잠금, 창 기반 프로그램 프리뷰·최종 렌더 합성 지원
