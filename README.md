...
- 효과 반영 Program 모니터: 선택 클립의 모션 키프레임·색상·속도·페이드·오디오 설정을 적용한 540p 프록시를 캐시하여 최종 출력 전 실제 편집 결과를 재생. 긴 클립은 재생 위치 주변 8초 창만 생성하고 끝에서 다음 효과 창으로 자동 연결해 초기 대기 시간을 제한
