...
def get_project(job_id: str) -> ProjectResponse:
    ...
    return ProjectResponse(
        ...
        hidden_video_tracks=job.get("hidden_video_tracks") or [],
        locked_audio_tracks=job.get("locked_audio_tracks") or [],
        muted_audio_tracks=job.get("muted_audio_tracks") or [],
        solo_audio_tracks=job.get("solo_audio_tracks") or [],
        transcript=job.get("transcript") or [],
        captions=job.get("captions") or [],
        waveform=job.get("waveform") or [],
...
def save_project(job_id: str, payload: ProjectState) -> ProjectResponse:
    ...
    updated = store.update(
        ...
        hidden_video_tracks=payload.hidden_video_tracks,
        locked_audio_tracks=payload.locked_audio_tracks,
        muted_audio_tracks=payload.muted_audio_tracks,
        solo_audio_tracks=payload.solo_audio_tracks,
        transcript=(
    ...
    return ProjectResponse(
        ...
        hidden_video_tracks=updated.get("hidden_video_tracks") or [],
        locked_audio_tracks=updated.get("locked_audio_tracks") or [],
        muted_audio_tracks=updated.get("muted_audio_tracks") or [],
        solo_audio_tracks=updated.get("solo_audio_tracks") or [],
